...
import (
	...
	_init_ "github.com/cdktf/cdktf-provider-external-go/external/v10/jsii"

	"github.com/aws/constructs-go/constructs/v10"
	"github.com/cdktf/cdktf-provider-external-go/external/v10/dataexternal/internal"
...
func (j *jsiiProxy_DataExternal) ForEach() cdktf.ITerraformIterator {
...
func NewDataExternal(scope constructs.Construct, id *string, config *DataExternalConfig) DataExternal {
	...
	if err := validateNewDataExternalParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataExternal)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func DataExternal_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateDataExternal_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataExternal_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataExternal_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DataExternal_IsTerraformDataSource(x interface{}) *bool {
	...
	if err := validateDataExternal_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DataExternal_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateDataExternal_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataExternal) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataExternal) ToHclTerraform() interface{} {
	var returns interface{}
